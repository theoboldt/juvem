...
class InvoiceManager
{
    ...
    public function createInvoice(Participation $participation)
    {
        ...
        $replace = [
            str_replace('&', 'u.', $participation->getPid()),
            str_replace('&', 'u.', $participation->getSalutation()),
            str_replace('&', 'u.', $participation->getSalutation()),
            str_replace('&', 'u.', $greetingFull),
            str_replace('&', 'u.', $participation->getNameFirst()),
            str_replace('&', 'u.', $participation->getNameLast()),
            str_replace('&', 'u.', $participation->getAddressStreet()),
            str_replace('&', 'u.', $participation->getAddressZip()),
            str_replace('&', 'u.', $participation->getAddressCity()),
            str_replace('&', 'u.', $participation->getEmail()),
            str_replace('&', 'u.', $invoice->getInvoiceNumber()),
            str_replace('&', 'u.', number_format($sumCents / 100, 2, ',', '.') . ' €'),
            str_replace('&', 'u.', $event->getTitle()),
            str_replace('&', 'u.', $eventStart),
            str_replace('&', 'u.', $eventEnd),
            str_replace('&', 'u.', ParticipationsParticipantsNamesGrouped::combinedParticipantsNames($participation)),
            str_replace('&', 'u.', $sumCents),
        ];
