...
class CustomizedParticipantsExportTest extends JuvemKernelTestCase
{
    ...
    public function testDefaultExport(): void
    {
        ...
        $this->assertEqualsSheetValue($sheet, 8, 2, 'Ms.');
        $this->assertEqualsSheetValue($sheet, 9, 2, 'Maria');
        $this->assertEqualsSheetValue($sheet, 10, 2, 'Doe');
        $this->assertEqualsSheetValue($sheet, 11, 2, 'Musterstrasse 25');
        $this->assertEqualsSheetValue($sheet, 12, 2, 'Musterstadt');
        $this->assertEqualsSheetValue($sheet, 13, 2, '70000');
        $this->assertEqualsSheetValue($sheet, 14, 2, 'doe+example@example.com');
        $this->assertEqualsSheetValue($sheet, 15, 2, '0163000000');
        ...
        $this->assertEqualsSheetValue($sheet, 8, 3, 'Ms.');
        $this->assertEqualsSheetValue($sheet, 9, 3, 'Maria');
        $this->assertEqualsSheetValue($sheet, 10, 3, 'Doe');
        $this->assertEqualsSheetValue($sheet, 11, 3, 'Musterstrasse 25');
        $this->assertEqualsSheetValue($sheet, 12, 3, 'Musterstadt');
        $this->assertEqualsSheetValue($sheet, 13, 3, '70000');
        $this->assertEqualsSheetValue($sheet, 14, 3, 'doe+example@example.com');
        $this->assertEqualsSheetValue($sheet, 15, 3, '0163000000');
        ...
        $this->assertEqualsSheetValue($sheet, 8, 4, 'Ms.');
        $this->assertEqualsSheetValue($sheet, 9, 4, 'Maria');
        $this->assertEqualsSheetValue($sheet, 10, 4, 'Doe');
        $this->assertEqualsSheetValue($sheet, 11, 4, 'Musterstrasse 25');
        $this->assertEqualsSheetValue($sheet, 12, 4, 'Musterstadt');
        $this->assertEqualsSheetValue($sheet, 13, 4, '70000');
        $this->assertEqualsSheetValue($sheet, 14, 4, 'doe+example@example.com');
        $this->assertEqualsSheetValue($sheet, 15, 4, '0163000000');
