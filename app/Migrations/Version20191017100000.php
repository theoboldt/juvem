...
final class Version20191017100000 extends AbstractMigration
{
    ...
    {
        $this->addSql(
            'CREATE TABLE recipe_feedback (id INT UNSIGNED AUTO_INCREMENT NOT NULL, rid INT UNSIGNED DEFAULT NULL, eid INT DEFAULT NULL, modified_by INT DEFAULT NULL, created_by INT DEFAULT NULL, people_count INT UNSIGNED NOT NULL, occurrence_date DATE NOT NULL, weight SMALLINT UNSIGNED NOT NULL, comment LONGTEXT NOT NULL, feedback_global SMALLINT NOT NULL, feedback JSON NOT NULL COMMENT \'(DC2Type:json_array)\', modified_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_A4B9E1C656D41083 (rid), INDEX IDX_A4B9E1C64FBDA576 (eid), INDEX IDX_A4B9E1C625F94802 (modified_by), INDEX IDX_A4B9E1C6DE12AB56 (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB'
        );
        $this->addSql(
