...
final class Version20211129180000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            "ALTER TABLE event ADD feedback_questionnaire JSON DEFAULT NULL COMMENT '(DC2Type:json_array)', ADD is_feedback_questionnaire_enabled TINYINT(1) DEFAULT '0' NOT NULL, ADD is_feedback_questionnaire_sent TINYINT(1) DEFAULT '0' NOT NULL, ADD feedback_day_after_event_count SMALLINT UNSIGNED DEFAULT 0 NOT NULL"
        );
        $this->addSql(
    ...
    {
        $this->addSql(
            'ALTER TABLE event DROP feedback_questionnaire, DROP is_feedback_questionnaire_enabled, DROP is_feedback_questionnaire_sent, DROP feedback_day_after_event_count'
        );
